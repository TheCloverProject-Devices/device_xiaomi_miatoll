...
git clone -b lineage-22.1 https://github.com/LineageOS/android_hardware_sony_timekeep.git hardware/sony/timekeep --depth=1

# hardware/xiaomi
git clone -b fifteen https://github.com/PixelOS-AOSP/hardware_xiaomi.git hardware/xiaomi --depth=1

# Vendor tree
git clone -b android-V https://github.com/Xiaomi-SD720G-Devices/aosp_vendor_xiaomi_miatoll.git vendor/xiaomi/miatoll --depth=1
